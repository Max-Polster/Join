const USERS_URL =
  "https://joinporttask-default-rtdb.europe-west1.firebasedatabase.app/";
const TASKS_URL =
  "https://joinporttask-default-rtdb.europe-west1.firebasedatabase.app/";
const CONTACTS_URL =
  "https://joinportcontacts-default-rtdb.europe-west1.firebasedatabase.app/";
...
let activePage = [false, false, false, false, false, false];
...
async function includeHTML() {
  ...
  if (retrievedUserString) {
    ...
    document.getElementById("userInitials").innerHTML = getInitials(
      activeUser.name
    );
  } else if (
    !retrievedUserString &&
...
function setBackground(i) {
  activePage = [false, false, false, false, false, false];
  activePage[i] = true;
  changeBackground(i);
}
